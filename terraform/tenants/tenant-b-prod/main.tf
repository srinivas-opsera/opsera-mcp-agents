# =============================================================================
# TenantB - Production Environment
# =============================================================================
...
terraform {
  ...
  backend "s3" {
    ...
    key    = "tenants/tenant-b/prod/terraform.tfstate"
    region = "us-east-1"
  }
}
...
module "vpc_eks" {
  ...
  # VPC Configuration - Using 10.4.x.x range for TenantB Prod
