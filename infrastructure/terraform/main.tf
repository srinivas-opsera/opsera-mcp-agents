...
resource "aws_lb" "main" {
  ...
  # Increase idle timeout for SSE connections
...
# =============================================================================
# Route 53 DNS + ACM Certificate (Optional - requires domain_name)
# =============================================================================
...
resource "aws_route53_record" "cert_validation" {
  for_each = var.domain_name != "" && var.hosted_zone_id != "" && var.create_certificate ? {
...
resource "aws_acm_certificate_validation" "main" {
  count = var.domain_name != "" && var.hosted_zone_id != "" && var.create_certificate ? 1 : 0
